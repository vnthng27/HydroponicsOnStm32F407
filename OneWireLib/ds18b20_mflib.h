...
#include <math.h>
#include "stm32f4xx.h"			// <-- choose the hal lib appropriate for your device
#include "stm32f4xx_gpio.h"
#include "stm32f4xx_rcc.h"
#define TXRX_PORT	GPIOB					// <-- select the 1-wire signal line port (GPIOA or GPIOB or ...)
#define TXRX_PIN	GPIO_Pin_2		// <-- select the 1-wire signal line pin (GPIO_PIN_1 or GPIO_PIN_2 or ...)
